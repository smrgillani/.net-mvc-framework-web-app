$(document).ready(function () {
    $("#AddNewsOrUpdate").click(function (event) {
        event.preventDefault();
        $.ajax({
            url: "/newsandupdates/create",
            success: function (temp) {
                $("#dialog-add-form").html(temp);
                $("#dialog-add-form").dialog(
                              {
                                  modal: true,
                                  title: "Add News Or Update",
                                  width: "600px",
                                  ...
                                  buttons: {
                                      "Save": function () {
                                          ...
                                          bValid = bValid && minLength(picture, "Please select a photo for News ! ", 1);
    ...
    $(".UpdateNewsOrUpdate").click(function (event) {
        event.preventDefault();
        $.ajax({
            url: $(this).attr('href'),
            success: function (temp) {
    ...
    $("#ChangeSettingsNewsOrUpdate").click(function (event) {
        event.preventDefault();
        $.ajax({
            url: $(this).attr('href'),
            success: function (temp) {
                ...
                $("#dialog-add-form").dialog(
                              {
                                  modal: true,
                                  title: "Change Settings Of News Or Update",
                                  width: "450px",
                                  show: { effect: 'drop', direction: "up" },
                                  hide: { effect: 'drop', direction: "down" },
                                  draggable: false,
