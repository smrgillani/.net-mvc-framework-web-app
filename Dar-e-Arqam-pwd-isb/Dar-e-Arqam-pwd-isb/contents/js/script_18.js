$(document).ready(function () {
    $("#AddNewSection").click(function (event) {
        ...
        $.ajax({
            ...
            success: function (temp) {
                ...
                $("#dialog-add-form").dialog(
                              {
                                  modal: true,
                                  title: "Add New Section To This Grade",
                                  width: "600px",
                                  ...
                                  buttons: {
                                      "Save": function () {
                                          var name = $("#Name"),
                                   allFields = $([]).add(name), tips = $(".form_msgs");
                                          ...
                                          bValid = bValid && checkRegexp(name, /^[a-zA-Z0-9\s]+$/, "Name of The Class Level should consist of A to Z , 0 to 9 letters.");
                                          if (bValid) {
    ...
    $(".UpdateExistingSection").click(function (event) {
        event.preventDefault();
        $.ajax({
            url: $(this).attr('href'),
            success: function (temp) {
